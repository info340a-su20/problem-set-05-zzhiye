...
*/
let inputEventResponder = document.querySelector("#dobInput");

inputEventResponder.addEventListener("input", function() {
  let userAge = getYearsSince(inputEventResponder.value);
  if (userAge < 13 || userAge > 200) {
    inputEventResponder.setCustomValidity("You need to be at least 13 years old.");
    document.querySelector("#dobFeedback").textContent = "You need to be at least 13 years old.";
  } else {
    inputEventResponder.setCustomValidity("");
  }
})
